...
//
#ifndef RTW_HEADER_Emulated_types_h_
#define RTW_HEADER_Emulated_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_struct_9UxdYJe4udzuwrp3psUiN_
#define DEFINED_TYPEDEF_FOR_struct_9UxdYJe4udzuwrp3psUiN_

struct struct_9UxdYJe4udzuwrp3psUiN
{
...
#ifndef struct_c_dsp_private_SlidingWindowAverageCG_Emulated_T
#define struct_c_dsp_private_SlidingWindowAverageCG_Emulated_T

struct c_dsp_private_SlidingWindowAverageCG_Emulated_T
{
...
#endif                // struct_c_dsp_private_SlidingWindowAverageCG_Emulated_T

#ifndef struct_px4_internal_block_PWM_Emulated_T
#define struct_px4_internal_block_PWM_Emulated_T

struct px4_internal_block_PWM_Emulated_T
{
...
#endif                              // struct_px4_internal_block_PWM_Emulated_T

#ifndef struct_cell_wrap_Emulated_T
#define struct_cell_wrap_Emulated_T

struct cell_wrap_Emulated_T
{
  uint32_T f1[8];
};

#endif                                 // struct_cell_wrap_Emulated_T

#ifndef struct_dsp_simulink_MovingAverage_Emulated_T
#define struct_dsp_simulink_MovingAverage_Emulated_T

struct dsp_simulink_MovingAverage_Emulated_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
  boolean_T TunablePropsChanged;
  cell_wrap_Emulated_T inputVarSize;
  c_dsp_private_SlidingWindowAverageCG_Emulated_T *pStatistic;
  int32_T NumChannels;
  c_dsp_private_SlidingWindowAverageCG_Emulated_T _pobj0;
};

#endif                          // struct_dsp_simulink_MovingAverage_Emulated_T

// Parameters (default storage)
typedef struct P_Emulated_T_ P_Emulated_T;

// Forward declaration for rtModel
typedef struct tag_RTM_Emulated_T RT_MODEL_Emulated_T;

#endif                                 // RTW_HEADER_Emulated_types_h_
