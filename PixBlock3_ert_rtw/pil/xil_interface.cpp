 ...
 *
 * PIL generated interface for code: "PixBlock3"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(PixBlock3_U.SerialIn[0]);
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(PixBlock3_Y.SerialOut[0]);
