...
//
#ifndef RTW_HEADER_pBLOCKAN_types_h_
#define RTW_HEADER_pBLOCKAN_types_h_
#include "rtwtypes.h"
...
#ifndef struct_c_dsp_private_SlidingWindowAverageCG_pBLOCKAN_T
#define struct_c_dsp_private_SlidingWindowAverageCG_pBLOCKAN_T

struct c_dsp_private_SlidingWindowAverageCG_pBLOCKAN_T
{
...
#endif                // struct_c_dsp_private_SlidingWindowAverageCG_pBLOCKAN_T

#ifndef struct_px4_internal_block_PWM_pBLOCKAN_T
#define struct_px4_internal_block_PWM_pBLOCKAN_T

struct px4_internal_block_PWM_pBLOCKAN_T
{
...
#endif                              // struct_px4_internal_block_PWM_pBLOCKAN_T

#ifndef struct_cell_wrap_pBLOCKAN_T
#define struct_cell_wrap_pBLOCKAN_T

struct cell_wrap_pBLOCKAN_T
{
  uint32_T f1[8];
};

#endif                                 // struct_cell_wrap_pBLOCKAN_T

#ifndef struct_dsp_simulink_MovingAverage_pBLOCKAN_T
#define struct_dsp_simulink_MovingAverage_pBLOCKAN_T

struct dsp_simulink_MovingAverage_pBLOCKAN_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
  boolean_T TunablePropsChanged;
  cell_wrap_pBLOCKAN_T inputVarSize;
  c_dsp_private_SlidingWindowAverageCG_pBLOCKAN_T *pStatistic;
  int32_T NumChannels;
  c_dsp_private_SlidingWindowAverageCG_pBLOCKAN_T _pobj0;
};

#endif                          // struct_dsp_simulink_MovingAverage_pBLOCKAN_T

// Parameters (default storage)
typedef struct P_pBLOCKAN_T_ P_pBLOCKAN_T;

// Forward declaration for rtModel
typedef struct tag_RTM_pBLOCKAN_T RT_MODEL_pBLOCKAN_T;

#endif                                 // RTW_HEADER_pBLOCKAN_types_h_
