...
MODEL                := Mainframe
MODULES              := Mainframe_data.c Mainframe_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c
MAKEFILE             := Mainframe.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Mainframe_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/guy-m/Documents/MATLAB/HIL-2.0/Mainframe/req;C:/Users/guy-m/Documents/MATLAB/HIL-2.0/Mainframe/req/Mainframe_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
