  ...
  ;%***********************
    ...
    ;%
      ...
      section.nData     = 608;
      section.data(608)  = dumData; %prealloc
	  ...
	  section.data(2).logicalSrcIdx = 731;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Mainframe_P.FixPtConstant_Value
	  section.data(3).logicalSrcIdx = 732;
	  section.data(3).dtTransOffset = 2;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  section.data(92).dtTransOffset = 148;
	  ...
	  section.data(100).dtTransOffset = 179;
	
	  ;% Mainframe_B.Subtract4
	  section.data(101).logicalSrcIdx = 100;
	  section.data(101).dtTransOffset = 188;
	
	  ;% Mainframe_B.MathFunction
	  section.data(102).logicalSrcIdx = 101;
	  section.data(102).dtTransOffset = 189;
	  ...
	  section.data(104).dtTransOffset = 201;
	
	  ;% Mainframe_B.VectorConcatenate_h
	  section.data(105).logicalSrcIdx = 104;
	  section.data(105).dtTransOffset = 202;
	  ...
	  section.data(109).dtTransOffset = 214;
	
	  ;% Mainframe_B.Sum2_h
	  section.data(110).logicalSrcIdx = 109;
	  section.data(110).dtTransOffset = 217;
	  ...
	  section.data(112).dtTransOffset = 223;
	
	  ;% Mainframe_B.Add
	  section.data(113).logicalSrcIdx = 112;
	  section.data(113).dtTransOffset = 226;
	  ...
	  section.data(116).dtTransOffset = 249;
	
	  ;% Mainframe_B.VectorConcatenate_e
	  section.data(117).logicalSrcIdx = 116;
	  section.data(117).dtTransOffset = 253;
	  ...
	  section.data(119).dtTransOffset = 260;
	  ...
	  section.data(121).dtTransOffset = 277;
	  ...
	  section.data(20).logicalSrcIdx = 143;
	  section.data(20).dtTransOffset = 19;
	
	  ;% Mainframe_B.CastToSingle1
	  section.data(21).logicalSrcIdx = 144;
	  section.data(21).dtTransOffset = 20;
	
	  ;% Mainframe_B.CastToSingle20
	  section.data(22).logicalSrcIdx = 145;
	  section.data(22).dtTransOffset = 21;
  ...
  targMap.checksum0 = 1338055871;
  targMap.checksum1 = 713334091;
  targMap.checksum2 = 3727939429;
  targMap.checksum3 = 1253909183;
