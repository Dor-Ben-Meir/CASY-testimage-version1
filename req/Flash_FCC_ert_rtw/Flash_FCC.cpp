...
static void Flash_FCC_SystemCore_release(const px4_internal_block_Subscriber_T
  *obj);
static void Flash_FCC_SystemCore_delete(const px4_internal_block_Subscriber_T
  *obj);
...
static void Flash_FCC_SystemCore_release_f(const px4_internal_block_PX4SCIWrit_T
  *obj);
static void Flash_FCC_SystemCore_delete_f(const px4_internal_block_PX4SCIWrit_T *
  obj);
static void matlabCodegenHandle_matlabCod_f(px4_internal_block_PX4SCIWrit_T *obj);
...
void Flash_FCC_step(void)
{
  ...
  boolean_T rtb_NOT;
  uint32_T PixhawkSoftware100Hz_ELAPS_T;
  int32_T i;
  ...
  if (sizeptr >= 80U) {
    MW_SCI_Receive(Flash_FCC_DW.obj.MW_SCIHANDLE, Flash_FCC_B.RxDataLocChar, 80U);
    memcpy((void *)&Flash_FCC_B.RxData[0], (void *)&Flash_FCC_B.RxDataLocChar[0],
           (uint32_T)((size_t)20 * sizeof(real32_T)));
    sizeptr = 0U;
  } else {
    memset(&Flash_FCC_B.RxData[0], 0, 20U * sizeof(real32_T));
    sizeptr = 1U;
  }
  ...
  if (rtb_NOT && (Flash_FCC_PrevZCX.TriggeredSubsystem_Trig_ZCE != POS_ZCSIG)) {
    ...
    memcpy(&Flash_FCC_B.In1_c[0], &Flash_FCC_B.RxData[0], 20U * sizeof(real32_T));
  }
  ...
  if (Flash_FCC_M->Timing.TaskCounters.TID[1] == 0) {
    ...
    if (zcEvent != NO_ZCEVENT) {
      if (Flash_FCC_DW.PixhawkSoftware100Hz_RESET_ELAP) {
        PixhawkSoftware100Hz_ELAPS_T = 0U;
      } else {
        PixhawkSoftware100Hz_ELAPS_T = Flash_FCC_M->Timing.clockTick1 -
          Flash_FCC_DW.PixhawkSoftware100Hz_PREV_T;
      }

      Flash_FCC_DW.PixhawkSoftware100Hz_PREV_T = Flash_FCC_M->Timing.clockTick1;
      Flash_FCC_DW.PixhawkSoftware100Hz_RESET_ELAP = false;

      // S-Function (any2byte): '<S24>/Byte Pack1' incorporates:
      //   Constant: '<S24>/Zero'
      ...
      if (Flash_FCC_DW.DiscreteTimeIntegrator_SYSTEM_E == 0) {
        if (rtb_NOT && (Flash_FCC_DW.DiscreteTimeIntegrator_PrevRese <= 0)) {
          Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE =
            Flash_FCC_P.DiscreteTimeIntegrator_IC;
        } else {
          Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE +=
            Flash_FCC_P.DiscreteTimeIntegrator_gainval * static_cast<real32_T>
            (PixhawkSoftware100Hz_ELAPS_T)
            * Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U;
        }
      }
      ...
      b_varargout_1 = uORB_read_step(Flash_FCC_DW.obj_o.orbMetadataObj,
      ...
      // Switch generated from: '<S11>/Switch'
      if (Flash_FCC_B.In1_c[3] > Flash_FCC_P.Switch_4_Threshold) {
        Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U = Flash_FCC_B.In1.x;
      } else {
        Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U = Flash_FCC_B.In1_c[16];
      }

      // End of Switch generated from: '<S11>/Switch'
      ...
      rtb_Fin_4_Cmd_rad = ((Flash_FCC_P.DiscreteTransferFcn_NumCoef[0] * rtb_u +
                            ...
                            Flash_FCC_DW.DiscreteTransferFcn_states) *
                           Flash_FCC_P.Gain2_Gain * rtb_Fin_4_Cmd_rad -
                           Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U) *
      ...
      if (Flash_FCC_DW.DiscreteTimeIntegrator_SYSTEM_l == 0) {
        if (rtb_NOT && (Flash_FCC_DW.DiscreteTimeIntegrator_PrevRe_d <= 0)) {
          Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE_m =
            Flash_FCC_P.DiscreteTimeIntegrator_IC_d;
        } else {
          Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE_m +=
            Flash_FCC_P.DiscreteTimeIntegrator_gainva_i * static_cast<real32_T>
            (PixhawkSoftware100Hz_ELAPS_T)
            * Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U_e;
        }
      }
      ...
      rtb_Fin_3_Cmd_rad = Flash_FCC_P.Constant_Value_p +
        Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE_m;
      ...
      rtb_Add3_a = Flash_FCC_P.Constant1_Value +
        Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE_m;
      ...
      rtb_Add3_a = -static_cast<real32_T>(cos(static_cast<real_T>(rtb_Add3_a))) *
      ...
      rtb_Fin_2_Cmd_rad = Flash_FCC_P.Constant2_Value +
        Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE_m;
      ...
      rtb_Add2 = -static_cast<real32_T>(cos(static_cast<real_T>
        (rtb_Fin_2_Cmd_rad))) * Flash_FCC_P.Zero_Value + static_cast<real32_T>
        (sin(static_cast<real_T>(rtb_Fin_2_Cmd_rad))) * Flash_FCC_P.Zero_Value;

      // Sum: '<S6>/Add10' incorporates:
      //   Constant: '<S6>/Constant3'
      //   Sum: '<S6>/Add11'

      rtb_Fin_2_Cmd_rad = Flash_FCC_P.Constant3_Value +
        Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE_m;
      ...
      rtb_Add3 = -static_cast<real32_T>(cos(static_cast<real_T>
        (rtb_Fin_2_Cmd_rad))) * Flash_FCC_P.Zero_Value + static_cast<real32_T>
        (sin(static_cast<real_T>(rtb_Fin_2_Cmd_rad))) * Flash_FCC_P.Zero_Value;
      ...
      if ((static_cast<real32_T>(fabs(static_cast<real_T>(rtb_Fin_3_Cmd_rad))) >
           rtb_Add16) || (static_cast<real32_T>(fabs(static_cast<real_T>
             (rtb_Add3_a))) > rtb_Add16) || (static_cast<real32_T>(fabs(
             static_cast<real_T>(rtb_Add2))) > rtb_Add16) ||
          (static_cast<real32_T>(fabs(static_cast<real_T>(rtb_Add3))) >
           rtb_Add16)) {
        // MinMax: '<S20>/Max'
        if ((rtb_Fin_3_Cmd_rad > rtb_Add3_a) || rtIsNaNF(rtb_Add3_a)) {
          rtb_Fin_2_Cmd_rad = rtb_Fin_3_Cmd_rad;
        } else {
          rtb_Fin_2_Cmd_rad = rtb_Add3_a;
        }

        if ((!(rtb_Fin_2_Cmd_rad > rtb_Add2)) && (!rtIsNaNF(rtb_Add2))) {
          rtb_Fin_2_Cmd_rad = rtb_Add2;
        }

        if ((!(rtb_Fin_2_Cmd_rad > rtb_Add3)) && (!rtIsNaNF(rtb_Add3))) {
          rtb_Fin_2_Cmd_rad = rtb_Add3;
        }

        // End of MinMax: '<S20>/Max'

        // Abs: '<S20>/Abs1'
        rtb_Fin_2_Cmd_rad = static_cast<real32_T>(fabs(static_cast<real_T>
          (rtb_Fin_2_Cmd_rad)));

        // Product: '<S20>/Multiply' incorporates:
        //   Product: '<S20>/Divide'

        rtb_Fin_3_Cmd_rad = rtb_Fin_3_Cmd_rad / rtb_Fin_2_Cmd_rad * rtb_Add16;

        // Product: '<S20>/Multiply1' incorporates:
        //   Product: '<S20>/Divide1'

        rtb_Add3_a = rtb_Add3_a / rtb_Fin_2_Cmd_rad * rtb_Add16;

        // Product: '<S20>/Multiply3' incorporates:
        //   Product: '<S20>/Divide2'

        rtb_Add3 = rtb_Add3 / rtb_Fin_2_Cmd_rad * rtb_Add16;

        // Product: '<S20>/Multiply2' incorporates:
        //   Product: '<S20>/Divide4'

        rtb_Add2 = rtb_Add2 / rtb_Fin_2_Cmd_rad * rtb_Add16;
      }
      ...
      // Sum: '<S6>/Add15'
      rtb_Fin_2_Cmd_rad = rtb_Fin_4_Cmd_rad + rtb_Fin_3_Cmd_rad;

      // SignalConversion generated from: '<S8>/Vector Concatenate'
      Flash_FCC_B.VectorConcatenate[1] = rtb_Fin_2_Cmd_rad;

      // Gain: '<S26>/Gain'
      rtb_Fin_2_Cmd_rad *= Flash_FCC_P.Gain_Gain_c;

      // Saturate: '<S10>/Saturation'
      if (rtb_Fin_2_Cmd_rad > Flash_FCC_P.Saturation_UpperSat) {
        rtb_Fin_2_Cmd_rad = Flash_FCC_P.Saturation_UpperSat;
      } else {
        if (rtb_Fin_2_Cmd_rad < Flash_FCC_P.Saturation_LowerSat) {
          rtb_Fin_2_Cmd_rad = Flash_FCC_P.Saturation_LowerSat;
        }
      }
      ...
      // Gain: '<S10>/Gain'
      rtb_Add16 = Flash_FCC_P.Gain_Gain_g * rtb_Fin_2_Cmd_rad;

      // Sum: '<S6>/Add12'
      rtb_Fin_2_Cmd_rad = rtb_Fin_4_Cmd_rad + rtb_Add3_a;
      ...
      if ((Flash_FCC_B.In1_c[0] != 0.0F) && (Flash_FCC_B.In1_c[1] >
        ...
        rtb_Add3_a = static_cast<real32_T>(floor(static_cast<real_T>(rtb_Add16 +
          Flash_FCC_P.One_Value_m)));
        if (rtIsNaNF(rtb_Add3_a) || rtIsInfF(rtb_Add3_a)) {
          rtb_Add3_a = 0.0F;
        } else {
          rtb_Add3_a = static_cast<real32_T>(fmod(static_cast<real_T>(rtb_Add3_a),
            65536.0));
        }

        Flash_FCC_B.pwmValue[0] = static_cast<uint16_T>(rtb_Add3_a < 0.0F ?
          static_cast<int32_T>(static_cast<uint16_T>(-static_cast<int16_T>(
          static_cast<uint16_T>(-rtb_Add3_a)))) : static_cast<int32_T>(
          static_cast<uint16_T>(rtb_Add3_a)));

        // Gain: '<S27>/Gain' incorporates:
        //   DataTypeConversion: '<S10>/Cast To Double'

        rtb_Add3_a = Flash_FCC_P.Gain_Gain_d * rtb_Fin_2_Cmd_rad;

        // Saturate: '<S10>/Saturation1'
        if (rtb_Add3_a > Flash_FCC_P.Saturation1_UpperSat) {
          rtb_Add3_a = Flash_FCC_P.Saturation1_UpperSat;
        } else {
          if (rtb_Add3_a < Flash_FCC_P.Saturation1_LowerSat) {
            rtb_Add3_a = Flash_FCC_P.Saturation1_LowerSat;
          }
        }
        ...
        rtb_Add3_a = static_cast<real32_T>(floor(static_cast<real_T>
          (Flash_FCC_P.Gain1_Gain * rtb_Add3_a + Flash_FCC_P.One1_Value_e)));
        if (rtIsNaNF(rtb_Add3_a) || rtIsInfF(rtb_Add3_a)) {
          rtb_Add3_a = 0.0F;
        } else {
          rtb_Add3_a = static_cast<real32_T>(fmod(static_cast<real_T>(rtb_Add3_a),
        ...
        Flash_FCC_B.pwmValue[1] = static_cast<uint16_T>(rtb_Add3_a < 0.0F ?
          static_cast<int32_T>(static_cast<uint16_T>(-static_cast<int16_T>(
          static_cast<uint16_T>(-rtb_Add3_a)))) : static_cast<int32_T>(
          static_cast<uint16_T>(rtb_Add3_a)));
        ...
        rtb_Add3_a = Flash_FCC_P.Gain_Gain_f * rtb_Fin_3_Cmd_rad;

        // Saturate: '<S10>/Saturation2'
        if (rtb_Add3_a > Flash_FCC_P.Saturation2_UpperSat) {
          rtb_Add3_a = Flash_FCC_P.Saturation2_UpperSat;
        } else {
          if (rtb_Add3_a < Flash_FCC_P.Saturation2_LowerSat) {
            rtb_Add3_a = Flash_FCC_P.Saturation2_LowerSat;
          }
        }
        ...
        rtb_Add3_a = static_cast<real32_T>(floor(static_cast<real_T>
          (Flash_FCC_P.Gain2_Gain_h * rtb_Add3_a + Flash_FCC_P.One2_Value_f)));
        if (rtIsNaNF(rtb_Add3_a) || rtIsInfF(rtb_Add3_a)) {
          rtb_Add3_a = 0.0F;
        } else {
          rtb_Add3_a = static_cast<real32_T>(fmod(static_cast<real_T>(rtb_Add3_a),
        ...
        Flash_FCC_B.pwmValue[2] = static_cast<uint16_T>(rtb_Add3_a < 0.0F ?
          static_cast<int32_T>(static_cast<uint16_T>(-static_cast<int16_T>(
          static_cast<uint16_T>(-rtb_Add3_a)))) : static_cast<int32_T>(
          static_cast<uint16_T>(rtb_Add3_a)));
        ...
        rtb_Add3_a = Flash_FCC_P.Gain_Gain_o * rtb_Fin_4_Cmd_rad;

        // Saturate: '<S10>/Saturation3'
        if (rtb_Add3_a > Flash_FCC_P.Saturation3_UpperSat) {
          rtb_Add3_a = Flash_FCC_P.Saturation3_UpperSat;
        } else {
          if (rtb_Add3_a < Flash_FCC_P.Saturation3_LowerSat) {
            rtb_Add3_a = Flash_FCC_P.Saturation3_LowerSat;
          }
        }
        ...
        rtb_Add3_a = static_cast<real32_T>(floor(static_cast<real_T>
          (Flash_FCC_P.Gain3_Gain * rtb_Add3_a + Flash_FCC_P.One3_Value_o)));
        if (rtIsNaNF(rtb_Add3_a) || rtIsInfF(rtb_Add3_a)) {
          rtb_Add3_a = 0.0F;
        } else {
          rtb_Add3_a = static_cast<real32_T>(fmod(static_cast<real_T>(rtb_Add3_a),
        ...
        Flash_FCC_B.pwmValue[3] = static_cast<uint16_T>(rtb_Add3_a < 0.0F ?
          static_cast<int32_T>(static_cast<uint16_T>(-static_cast<int16_T>(
          static_cast<uint16_T>(-rtb_Add3_a)))) : static_cast<int32_T>(
          static_cast<uint16_T>(rtb_Add3_a)));
      ...
      // End of MATLABSystem: '<S10>/PX4 PWM Output1'
      ...
      // SignalConversion generated from: '<S8>/Vector Concatenate'
      Flash_FCC_B.VectorConcatenate[2] = rtb_Fin_2_Cmd_rad;
      ...
      if (Flash_FCC_B.In1_c[2] > Flash_FCC_P.Switch_4_Threshold_n) {
      ...
      Flash_FCC_DW.DiscreteTimeIntegrator_SYSTEM_E = 0U;
      Flash_FCC_DW.DiscreteTimeIntegrator_PrevRese = static_cast<int8_T>(rtb_NOT);

      // Update for DiscreteTransferFcn: '<S14>/Discrete Transfer Fcn'
      Flash_FCC_DW.DiscreteTransferFcn_states = rtb_u;

      // Update for DiscreteIntegrator: '<S1>/Discrete-Time Integrator'
      Flash_FCC_DW.DiscreteTimeIntegrator_SYSTEM_l = 0U;
      Flash_FCC_DW.DiscreteTimeIntegrator_PrevRe_d = static_cast<int8_T>(rtb_NOT);
      Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U_e =
        Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U;
...
void Flash_FCC_initialize(void)
{
...

  {
    ...
    Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE =
      Flash_FCC_P.DiscreteTimeIntegrator_IC;
    Flash_FCC_DW.DiscreteTimeIntegrator_PrevRese = 2;
    Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U = 0.0F;
    ...
    Flash_FCC_DW.DiscreteTimeIntegrator_DSTATE_m =
      Flash_FCC_P.DiscreteTimeIntegrator_IC_d;
    Flash_FCC_DW.DiscreteTimeIntegrator_PrevRe_d = 2;
    Flash_FCC_DW.DiscreteTimeIntegrator_PREV_U_e = 0.0F;
    ...
    // Enable for Triggered SubSystem: '<Root>/Pixhawk Software - 100 Hz'
    Flash_FCC_DW.PixhawkSoftware100Hz_RESET_ELAP = true;

    // Enable for DiscreteIntegrator: '<S14>/Discrete-Time Integrator'
    Flash_FCC_DW.DiscreteTimeIntegrator_SYSTEM_E = 1U;

    // Enable for DiscreteIntegrator: '<S1>/Discrete-Time Integrator'
    Flash_FCC_DW.DiscreteTimeIntegrator_SYSTEM_l = 1U;

    // End of Enable for SubSystem: '<Root>/Pixhawk Software - 100 Hz'
  }
}
...
void Flash_FCC_terminate(void)
{
  ...
  matlabCodegenHandle_matlabCodeg(&Flash_FCC_DW.obj_o);
  ...
  matlabCodegenHandle_matlabCod_f(&Flash_FCC_DW.obj_k);
