...
//
// File: Copy_of_Corneto_flight_program_control_types.h
//
...
//
#ifndef RTW_HEADER_Copy_of_Corneto_flight_program_control_types_h_
#define RTW_HEADER_Copy_of_Corneto_flight_program_control_types_h_
#include "rtwtypes.h"
...
#ifndef struct_px4_internal_block_PWM_Copy_o_T
#define struct_px4_internal_block_PWM_Copy_o_T

struct px4_internal_block_PWM_Copy_o_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
...
#endif                                // struct_px4_internal_block_PWM_Copy_o_T
...
#ifndef struct_cell_wrap_Copy_of_Corneto_fli_T
#define struct_cell_wrap_Copy_of_Corneto_fli_T

struct cell_wrap_Copy_of_Corneto_fli_T
{
  uint32_T f1[8];
};

#endif                                // struct_cell_wrap_Copy_of_Corneto_fli_T
...
struct dsp_simulink_MovingAverage_Co_T
{
  ...
  cell_wrap_Copy_of_Corneto_fli_T inputVarSize;
...
typedef struct P_Copy_of_Corneto_flight_prog_T_ P_Copy_of_Corneto_flight_prog_T;

// Forward declaration for rtModel
typedef struct tag_RTM_Copy_of_Corneto_fligh_T RT_MODEL_Copy_of_Corneto_flig_T;

#endif            // RTW_HEADER_Copy_of_Corneto_flight_program_control_types_h_
