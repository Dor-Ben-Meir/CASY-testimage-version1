...
//
#ifndef RTW_HEADER_PixBlock_h_
#define RTW_HEADER_PixBlock_h_
#include <math.h>
#include <stddef.h>
#include "rtwtypes.h"
...
struct DW_PixBlock_T {
  px4_internal_block_PWM_PixBlock_T obj;// '<S10>/PX4 PWM Output1'
...
extern "C" {
  ...
  extern P_PixBlock_T PixBlock_P;
...
extern "C" {
  ...
  extern struct B_PixBlock_T PixBlock_B;
...
extern struct DW_PixBlock_T PixBlock_DW;

// Zero-crossing (trigger) state
extern PrevZCX_PixBlock_T PixBlock_PrevZCX;
...
extern "C" {
  ...
  // External inputs (root inport signals with default storage)
  extern struct ExtU_PixBlock_T PixBlock_U;

  // External outputs (root outports fed by signals with default storage)
  extern struct ExtY_PixBlock_T PixBlock_Y;
...
extern "C" {
  ...
  extern void PixBlock_initialize(void);
  extern void PixBlock_step(void);
  extern void PixBlock_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_PixBlock_T *const PixBlock_M;
...
//
//  hilite_system('PIL_NO_RPI_new/Flight Control Computer1/PixBlock')    - opens subsystem PIL_NO_RPI_new/Flight Control Computer1/PixBlock
//  hilite_system('PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Kp') - opens and selects block Kp
//
//  Here is the system hierarchy for this model
//
//  '<Root>' : 'PIL_NO_RPI_new/Flight Control Computer1'
//  '<S1>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock'
//  '<S2>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1'
//  '<S3>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Autopilot'
//  '<S4>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Convert to Bus'
//  '<S5>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Convert to Vector'
//  '<S6>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Fin Allocation'
//  '<S7>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/IMU - Merge'
//  '<S8>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Inertial Navigation System'
//  '<S9>'   : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Real Gyro'
//  '<S10>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Servo Commands'
//  '<S11>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Autopilot/Calculate U'
//  '<S12>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Autopilot/Phi_Control'
//  '<S13>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Autopilot/Phi_Control/Gain_Lookup'
//  '<S14>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Convert to Bus/100Hz Reset'
//  '<S15>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Fin Allocation/control_allocation'
//  '<S16>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Inertial Navigation System/INS (INCOMPLETE)'
//  '<S17>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Servo Commands/100Hz Progress'
//  '<S18>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Servo Commands/Radians to Degrees'
//  '<S19>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Servo Commands/Radians to Degrees1'
//  '<S20>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Servo Commands/Radians to Degrees2'
//  '<S21>'  : 'PIL_NO_RPI_new/Flight Control Computer1/PixBlock/Emulated Pixhawk1/Servo Commands/Radians to Degrees3'

#endif                                 // RTW_HEADER_PixBlock_h_
