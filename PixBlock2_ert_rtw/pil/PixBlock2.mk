...
## Generated on : Tue Apr 13 10:26:44 2021
## Final product: ./PixBlock2.pre.o
...
MODELREF_LIBS = ../PixBlock2.cpp.o ../PixBlock2_data.cpp.o ../rt_zcfcn.cpp.o
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) $(OBJS) --start-group ../PixBlock2.cpp.o ../PixBlock2_data.cpp.o ../rt_zcfcn.cpp.o --end-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
xil_interface.cpp.o : $(START_DIR)/PixBlock2_ert_rtw/pil/xil_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
