...
//
#ifndef RTW_HEADER_px4demo_uORBRead_types_h_
#define RTW_HEADER_px4demo_uORBRead_types_h_
#include "rtwtypes.h"
...
#ifndef struct_cell_wrap_px4demo_uORBRead_T
#define struct_cell_wrap_px4demo_uORBRead_T

struct cell_wrap_px4demo_uORBRead_T
{
  uint32_T f1[8];
};

#endif                                 // struct_cell_wrap_px4demo_uORBRead_T

#ifndef struct_dsp_simulink_MovingAverage_px_T
#define struct_dsp_simulink_MovingAverage_px_T

struct dsp_simulink_MovingAverage_px_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
  boolean_T TunablePropsChanged;
  cell_wrap_px4demo_uORBRead_T inputVarSize;
  g_dsp_private_SlidingWindowAv_T *pStatistic;
  int32_T NumChannels;
  g_dsp_private_SlidingWindowAv_T _pobj0;
};

#endif                                // struct_dsp_simulink_MovingAverage_px_T

// Parameters (default storage)
typedef struct P_px4demo_uORBRead_T_ P_px4demo_uORBRead_T;

// Forward declaration for rtModel
typedef struct tag_RTM_px4demo_uORBRead_T RT_MODEL_px4demo_uORBRead_T;

#endif                                 // RTW_HEADER_px4demo_uORBRead_types_h_
