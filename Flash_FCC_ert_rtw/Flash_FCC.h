...
typedef struct {
  uint8_T RxDataLocChar[92];
  real32_T In1_c[23];                  // '<S31>/In1'
  real32_T RxData[23];
  uint8_T TxDataLocChar[75];
  px4_Bus_sensor_gyro In1;             // '<S23>/In1'
  px4_Bus_sensor_gyro b_varargout_2;
  real32_T VectorConcatenate[18];      // '<S9>/Vector Concatenate'
  uint8_T VectorConcatenate1[75];      // '<S10>/Vector Concatenate1'
  uint16_T pwmValue[8];
} B_Flash_FCC_T;
...
typedef struct {
  ...
  px4_internal_block_PX4SCIWrit_T obj_k;// '<S1>/Serial Transmit'
  px4_internal_block_PWM_Flash__T obj_a;// '<S11>/PX4 PWM Output1'
  real32_T Delay_DSTATE;               // '<S3>/Delay'
  real32_T DiscreteTransferFcn_states; // '<S14>/Discrete Transfer Fcn'
  real32_T Delay_DSTATE_n;             // '<S26>/Delay'
...
struct P_Flash_FCC_T_ {
  ...
  real32_T Switch_4_Threshold_k;     // Computed Parameter: Switch_4_Threshold_k
                                        //  Referenced by: '<S8>/Switch'
...
//  Block '<S24>/One10' : Unused code path elimination
//  Block '<S24>/One11' : Unused code path elimination
//  Block '<S9>/Cast To Single' : Eliminate redundant data type conversion
...
//  '<S6>'   : 'Flash_FCC/Pixhawk Software - 100 Hz/Fin Allocation1'
//  '<S7>'   : 'Flash_FCC/Pixhawk Software - 100 Hz/Gyro'
//  '<S8>'   : 'Flash_FCC/Pixhawk Software - 100 Hz/INS'
//  '<S9>'   : 'Flash_FCC/Pixhawk Software - 100 Hz/Send to HIL'
//  '<S10>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Serial Send'
//  '<S11>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Servos'
//  '<S12>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Subsystem1'
//  '<S13>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Autopilot/Calculate U'
//  '<S14>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Autopilot/Phi Ctrl'
//  '<S15>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Autopilot/Phi Ctrl/If Action Subsystem'
//  '<S16>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Autopilot/Phi Ctrl/If Action Subsystem1'
//  '<S17>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Fin Allocation1/Saturation'
//  '<S18>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Fin Allocation1/Saturation/Check_Limit_exceeding'
//  '<S19>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Fin Allocation1/Saturation/Pass'
//  '<S20>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Fin Allocation1/Saturation/Saturate'
...
//  '<S24>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/INS/INS (INCOMPLETE)'
//  '<S25>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Serial Send/Header'
//  '<S26>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Servos/100Hz Progress'
//  '<S27>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Servos/Radians to Degrees'
//  '<S28>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Servos/Radians to Degrees1'
//  '<S29>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Servos/Radians to Degrees2'
//  '<S30>'  : 'Flash_FCC/Pixhawk Software - 100 Hz/Servos/Radians to Degrees3'
