###########################################################################
## Makefile generated for component 'GPS32'. 
## 
## Makefile     : GPS32.mk
## Generated on : Sun May 09 18:57:58 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/GPS32.pre.o
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GPS32.pre.o
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/px4/include -I$(START_DIR)/GPS32_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/serial -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=GPS32 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_uORB_Read.cpp.o GPS32.cpp.o GPS32_data.cpp.o MW_PX4_TaskControl.cpp.o nuttxinitialize.cpp.o MW_PX4_rtiostream_serial.cpp.o rtiostream_interface.o ext_svr_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/GPS32_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/GPS32_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/GPS32_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


GPS32.cpp.o : $(START_DIR)/GPS32_ert_rtw/GPS32.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


GPS32_data.cpp.o : $(START_DIR)/GPS32_ert_rtw/GPS32_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
