...
## Generated on : Mon May 10 16:29:06 2021
## Final product: ./Peservoblock.pre.o
...
MODELREF_LIBS = ../MW_PX4_PWM.cpp.o ../Peservoblock.cpp.o ../Peservoblock_data.cpp.o ../rtGetInf.cpp.o ../rtGetNaN.cpp.o ../rt_nonfinite.cpp.o ../rt_zcfcn.cpp.o
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) $(OBJS) --start-group ../MW_PX4_PWM.cpp.o ../Peservoblock.cpp.o ../Peservoblock_data.cpp.o ../rtGetInf.cpp.o ../rtGetNaN.cpp.o ../rt_nonfinite.cpp.o ../rt_zcfcn.cpp.o --end-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
xil_interface.cpp.o : $(START_DIR)/Peservoblock_ert_rtw/pil/xil_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
