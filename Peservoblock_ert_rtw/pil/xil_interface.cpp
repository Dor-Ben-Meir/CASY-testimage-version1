 ...
 *
 * PIL generated interface for code: "Peservoblock"
 *
 */
      ...
      if (!initComplete) {
...

        {
          void * dataAddress = (void *)
            &(Peservoblock_P.Flight_Logic.Ax_launch_accel_threshold_mps2);
        ...
        {
          void * dataAddress = (void *)
            &(Peservoblock_P.Flight_Logic.h_apogee_timer_threshold_sec);
          xil_fcnid0_ws_params[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_ws_params[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Peservoblock_U.SerialIn[0]);
