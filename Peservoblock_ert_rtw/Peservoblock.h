...
//
#ifndef RTW_HEADER_Peservoblock_h_
#define RTW_HEADER_Peservoblock_h_
#include <math.h>
#include <stddef.h>
#include "rtwtypes.h"
...
struct DW_Peservoblock_T {
  dsp_simulink_MovingAverage_Peservoblock_T obj;// '<S17>/Moving Average1'
  px4_internal_block_PWM_Peservoblock_T obj_j;// '<S15>/PX4 PWM Output1'
...
extern "C" {
  ...
  extern P_Peservoblock_T Peservoblock_P;
...
extern "C" {
  ...
  extern struct B_Peservoblock_T Peservoblock_B;
...
extern struct DW_Peservoblock_T Peservoblock_DW;

// Zero-crossing (trigger) state
extern PrevZCX_Peservoblock_T Peservoblock_PrevZCX;
...
extern "C" {
  ...
  // External inputs (root inport signals with default storage)
  extern struct ExtU_Peservoblock_T Peservoblock_U;

  // External outputs (root outports fed by signals with default storage)
  extern struct ExtY_Peservoblock_T Peservoblock_Y;
...
extern "C" {
  ...
  extern void Peservoblock_initialize(void);
  extern void Peservoblock_step(void);
  extern void Peservoblock_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_Peservoblock_T *const Peservoblock_M;
...
//
//  hilite_system('PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock')    - opens subsystem PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock
//  hilite_system('PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Kp') - opens and selects block Kp
//
//  Here is the system hierarchy for this model
//
//  '<Root>' : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC'
//  '<S1>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock'
//  '<S2>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk'
//  '<S3>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot'
//  '<S4>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Convert to Bus'
//  '<S5>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Convert to Vector'
//  '<S6>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/IMU - Merge'
//  '<S7>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Inertial Navigation System'
//  '<S8>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Real Gyro'
//  '<S9>'   : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Calculate U1'
//  '<S10>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software'
//  '<S11>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Fin Allocation'
//  '<S12>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic'
//  '<S13>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/IMU_Filter'
//  '<S14>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Phi_Control'
//  '<S15>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Servo Commands'
//  '<S16>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Fin Allocation/control_allocation'
//  '<S17>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Apogee_Detection_Logic'
//  '<S18>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Enumeration'
//  '<S19>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Launch_Detection_Logic'
//  '<S20>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/MECO_Detection_Logic'
//  '<S21>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Recovery_Logic'
//  '<S22>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Apogee_Detection_Logic/Compare To Constant'
//  '<S23>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Apogee_Detection_Logic/Compare To Constant1'
//  '<S24>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Apogee_Detection_Logic/Compare To Constant3'
//  '<S25>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Apogee_Detection_Logic/Detect Decrease'
//  '<S26>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Apogee_Detection_Logic/Enable_Timer_Logic'
//  '<S27>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Apogee_Detection_Logic/Latch_Signal'
//  '<S28>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Launch_Detection_Logic/Compare To Constant'
//  '<S29>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Launch_Detection_Logic/Compare To Constant1'
//  '<S30>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Launch_Detection_Logic/Enable_Timer_Logic'
//  '<S31>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Launch_Detection_Logic/Latch_Signal'
//  '<S32>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/MECO_Detection_Logic/Compare To Constant1'
//  '<S33>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/MECO_Detection_Logic/Compare To Constant2'
//  '<S34>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/MECO_Detection_Logic/Compare To Constant3'
//  '<S35>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/MECO_Detection_Logic/Enable_Timer_Logic'
//  '<S36>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/MECO_Detection_Logic/Latch_Signal'
//  '<S37>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Recovery_Logic/Compare To Constant1'
//  '<S38>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Recovery_Logic/Compare To Constant3'
//  '<S39>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Recovery_Logic/Enable_Timer_Logic'
//  '<S40>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Flight_Logic/Recovery_Logic/Latch_Signal'
//  '<S41>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Phi_Control/Gain_Lookup'
//  '<S42>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Servo Commands/100Hz Progress'
//  '<S43>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Servo Commands/Radians to Degrees'
//  '<S44>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Servo Commands/Radians to Degrees1'
//  '<S45>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Servo Commands/Radians to Degrees2'
//  '<S46>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Autopilot/Flight_Software/Servo Commands/Radians to Degrees3'
//  '<S47>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Convert to Bus/100Hz Reset'
//  '<S48>'  : 'PILEncoder/Flight Control Computer/FCC - Real or Emulated/Emulated FCC/Peservoblock/Emulated Pixhawk/Inertial Navigation System/INS (INCOMPLETE)'

#endif                                 // RTW_HEADER_Peservoblock_h_
