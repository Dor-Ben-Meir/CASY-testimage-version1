...
//
#ifndef RTW_HEADER_Peservoblock_types_h_
#define RTW_HEADER_Peservoblock_types_h_
#include "rtwtypes.h"
...
#ifndef struct_c_dsp_private_SlidingWindowAverageCG_Peservoblock_T
#define struct_c_dsp_private_SlidingWindowAverageCG_Peservoblock_T

struct c_dsp_private_SlidingWindowAverageCG_Peservoblock_T
{
...
#endif            // struct_c_dsp_private_SlidingWindowAverageCG_Peservoblock_T

#ifndef struct_px4_internal_block_PWM_Peservoblock_T
#define struct_px4_internal_block_PWM_Peservoblock_T

struct px4_internal_block_PWM_Peservoblock_T
{
...
#endif                          // struct_px4_internal_block_PWM_Peservoblock_T

#ifndef struct_cell_wrap_Peservoblock_T
#define struct_cell_wrap_Peservoblock_T

struct cell_wrap_Peservoblock_T
{
  uint32_T f1[8];
};

#endif                                 // struct_cell_wrap_Peservoblock_T

#ifndef struct_dsp_simulink_MovingAverage_Peservoblock_T
#define struct_dsp_simulink_MovingAverage_Peservoblock_T

struct dsp_simulink_MovingAverage_Peservoblock_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
  boolean_T TunablePropsChanged;
  cell_wrap_Peservoblock_T inputVarSize;
  c_dsp_private_SlidingWindowAverageCG_Peservoblock_T *pStatistic;
  int32_T NumChannels;
  c_dsp_private_SlidingWindowAverageCG_Peservoblock_T _pobj0;
};

#endif                      // struct_dsp_simulink_MovingAverage_Peservoblock_T

// Parameters (default storage)
typedef struct P_Peservoblock_T_ P_Peservoblock_T;

// Forward declaration for rtModel
typedef struct tag_RTM_Peservoblock_T RT_MODEL_Peservoblock_T;

#endif                                 // RTW_HEADER_Peservoblock_types_h_
