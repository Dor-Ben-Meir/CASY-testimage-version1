###########################################################################
## Makefile generated for component 'Quadrature_Encoder_RPi_SFunction'. 
## 
## Makefile     : Quadrature_Encoder_RPi_SFunction.mk
## Generated on : Sun May 02 14:34:49 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Quadrature_Encoder_RPi_SFunction.elf
...
PRODUCT_NAME              = Quadrature_Encoder_RPi_SFunction
MAKEFILE                  = Quadrature_Encoder_RPi_SFunction.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/sasson/Desktop/HILsim/Mainframe
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Quadrature_Encoder_RPi_SFunction.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Quadrature_Encoder_RPi_SFunction_ert_rtw -I$(MATLAB_WORKSPACE)/C/Users/sasson/Desktop/Rpi_encoder/home/pi/wiringPi/wiringPi -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/rtw/c/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DEXTMODE_XCP_TRIGGER_SUPPORT -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=1000000 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
DEFINES_SKIPFORSIL = -D__linux__ -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -DRT
DEFINES_STANDARD = -DMODEL=Quadrature_Encoder_RPi_SFunction -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = xcp_ext_work.c.o Quadrature_Encoder_RPi_SFunction.c.o Quadrature_Encoder_RPi_SFunction_data.c.o xcp_ext_common.c.o xcp_ext_classic_trigger.c.o xcp.c.o xcp_standard.c.o xcp_daq.c.o xcp_calibration.c.o xcp_fifo.c.o xcp_transport.c.o xcp_mem_default.c.o xcp_drv_rtiostream.c.o xcp_frame_tcp.c.o xcp_ext_param_default_tcp.c.o Quad_Encoder_sfn_wrapper.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o rtiostream_utils.c.o xcp_platform_default.c.o
...
%.c.o : $(START_DIR)/Quadrature_Encoder_RPi_SFunction_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Quadrature_Encoder_RPi_SFunction_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Quadrature_Encoder_RPi_SFunction_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Quadrature_Encoder_RPi_SFunction_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Quadrature_Encoder_RPi_SFunction.c.o : $(START_DIR)/Quadrature_Encoder_RPi_SFunction_ert_rtw/Quadrature_Encoder_RPi_SFunction.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Quadrature_Encoder_RPi_SFunction_data.c.o : $(START_DIR)/Quadrature_Encoder_RPi_SFunction_ert_rtw/Quadrature_Encoder_RPi_SFunction_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
Quad_Encoder_sfn_wrapper.c.o : $(START_DIR)/Quad_Encoder_sfn_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
