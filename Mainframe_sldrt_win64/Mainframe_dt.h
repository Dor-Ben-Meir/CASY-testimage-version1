...
static uint_T rtDataTypeSizes[] = {
  ...
  sizeof(struct_iLoOqqsxNZRVPJUkO5oSDB),
...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&Mainframe_B.Fin_1), 0, 0, 285 },

  { (char_T *)(&Mainframe_B.CastToSingle18), 1, 0, 25 },
  ...
  { (char_T *)(&Mainframe_DW.Attitude_PWORK.LoggedData[0]), 11, 0, 110 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&Mainframe_P.CalibrationTime_Y0), 0, 0, 2557 },

  { (char_T *)(&Mainframe_P.Zero_Value_i), 1, 0, 1 },

  { (char_T *)(&Mainframe_P.Constant_Value_hg), 5, 0, 3 },

  { (char_T *)(&Mainframe_P.One_Value_j), 8, 0, 1 },
