...
#ifndef DEFINED_TYPEDEF_FOR_struct_iLoOqqsxNZRVPJUkO5oSDB_
#define DEFINED_TYPEDEF_FOR_struct_iLoOqqsxNZRVPJUkO5oSDB_
...
typedef struct {
  ...
  struct_Ww70OUmJnjMrjHguTkjSfE Virtual_IMU;
