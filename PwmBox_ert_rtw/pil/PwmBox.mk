...
## 
## Makefile     : PwmBox.mk
## Generated on : Mon May 10 17:14:50 2021
## Final product: ./PwmBox.pre.o
...
MODELREF_LIBS = ../MW_PX4_PWM.cpp.o ../PwmBox.cpp.o ../PwmBox_data.cpp.o ../rtGetInf.cpp.o ../rtGetNaN.cpp.o ../rt_nonfinite.cpp.o ../rt_zcfcn.cpp.o
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) $(OBJS) --start-group ../MW_PX4_PWM.cpp.o ../PwmBox.cpp.o ../PwmBox_data.cpp.o ../rtGetInf.cpp.o ../rtGetNaN.cpp.o ../rt_nonfinite.cpp.o ../rt_zcfcn.cpp.o --end-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
xil_interface.cpp.o : $(START_DIR)/PwmBox_ert_rtw/pil/xil_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
