 ...
 *
 * PIL generated interface for code: "PwmBox"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(PwmBox_U.SerialIn);
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(PwmBox_Y.signal1);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(uint16_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(PwmBox_Y.signal2);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(uint16_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(PwmBox_Y.signal3);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(uint16_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(PwmBox_Y.signal4);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(uint16_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(PwmBox_Y.signal1);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 1 * sizeof(uint16_T);
