###########################################################################
## Makefile generated for component 'px4demo_PWM'. 
## 
## Makefile     : px4demo_PWM.mk
## Generated on : Sun May 09 19:41:42 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/px4demo_PWM.pre.o
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/px4demo_PWM.pre.o
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/px4/include -I$(START_DIR)/px4demo_PWM_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/serial -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=px4demo_PWM -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PX4_PWM.cpp.o MW_uORB_Read.cpp.o px4demo_PWM.cpp.o px4demo_PWM_data.cpp.o MW_PX4_TaskControl.cpp.o nuttxinitialize.cpp.o
...
%.o : $(START_DIR)/px4demo_PWM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/px4demo_PWM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/px4demo_PWM_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


px4demo_PWM.cpp.o : $(START_DIR)/px4demo_PWM_ert_rtw/px4demo_PWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


px4demo_PWM_data.cpp.o : $(START_DIR)/px4demo_PWM_ert_rtw/px4demo_PWM_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
